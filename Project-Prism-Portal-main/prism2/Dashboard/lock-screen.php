...
<!-- Mirrored from themesdesign.in/upzet/layouts/auth-lock-screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Aug 2024 06:51:47 GMT -->
<head>
        
        <meta charset="utf-8" />
        <title>Lock Screen | Upzet - Admin & Dashboard Template</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-8">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="">
                                    ...
                                    <form class="form-horizontal" action="https://themesdesign.in/upzet/layouts/index.html">
                                        <div class="row">
                                            <div class="col-md-12">
                        ...
                        <div class="mt-5 text-center">
                            <p class="text-white-50">Not you ? return<a href="auth-login.html" class="fw-medium text-primary"> Sign In </a> </p>
